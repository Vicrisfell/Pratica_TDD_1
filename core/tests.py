...
class LivroFormTest(TestCase):
    def test_fields_in_form(self):
        form = LivroForm()
        expected = ['titulo', 'editora','autor','isbn','ano','paginas',]
        self.assertSequenceEqual(expected, list(form.fields))
    
    def test_form_all_OK(self):
        dados = dict(titulo='Contos do Machado de Assis', editora='editora Brasil', autor='Machado de Assis', isbn='1234567890000', ano=1996, paginas=000)
    ...
    def test_form_without_data_5(self):
        dados = dict(paginas='0')
        form = LivroForm(dados)
        errors = form.errors
        errors_list = errors['paginas']
        msg = 'Informe quantidade de pagina do livro.'
        self.assertEqual([msg], errors_list)        
    ...
    def test_form_without_data_6(self):
        ...
        msg = 'Deve ter pelo menos quatro caracteres.'
        self.assertEqual([msg], errors_list)              
    ...
    def test_form_less_than_03_character_3(self):
        ...
        errors = form.errors
        errors_list = errors['paginas']
        msg = 'paginas deve ter 3 caracteres e NUMÉRICOS'
        self.assertEqual([msg], errors_list)        
    ...
    def test_form_less_than_04_character_1(self):
        ...
        errors = form.errors
        errors_list = errors['ano']
        msg = 'deve ter 4 caracteres e NUMÉRICOS'
        self.assertEqual([msg], errors_list)        
